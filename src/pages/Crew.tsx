...
function Crew() {
  ...
  return (
    <main className="overflow-y-auto w-screen h-screen bg-[url(/src/assets/crew/background-crew-mobile.jpg)] md:bg-[url(/src/assets/crew/background-crew-tablet.jpg)] xl:bg-[url(/src/assets/crew/background-crew-desktop.jpg)] bg-cover bg-center flex flex-col items-center text-white pt-[88px] md:pt-[96px] xl:pt-[136px]">
