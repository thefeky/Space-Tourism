...
function Homepage() {
  return (
    <main className="w-screen h-screen bg-[url(/src/assets/home/background-home-mobile.jpg)] md:bg-[url(/src/assets/home/background-home-tablet.jpg)] xl:bg-[url(/src/assets/home/background-home-desktop.jpg)] bg-cover bg-center overflow-y-auto relative pt-[88px] md:pt-[96px] xl:pt-[136px]">
