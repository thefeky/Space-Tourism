...
function Technology() {
  ...
  return (
    <main className="overflow-y-auto md:overflow-y-hidden w-screen h-screen bg-[url(/src/assets/technology/background-technology-mobile.jpg)] md:bg-[url(/src/assets/technology/background-technology-tablet.jpg)] xl:bg-[url(/src/assets/technology/background-technology-desktop.jpg)] bg-cover bg-center flex flex-col items-center text-white pt-[88px] md:pt-[96px] xl:pt-[136px]">
